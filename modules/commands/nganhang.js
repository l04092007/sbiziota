...
module.exports.config = {
    ...
    credits: "DungUwU mod by JRT", // Công nhận module sở hữu là ai
    description: "ngân hàng xD", // Thông tin chi tiết về lệnh
    commandCategory: "Tài chính", // Thuộc vào nhóm nào: system, other, game-sp, game-mp, random-img, edit-img, media, economy, ...
