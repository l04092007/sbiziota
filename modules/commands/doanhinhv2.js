...
module.exports.handleReply = async function ({
    ...
    case "choosee": {
        ...
        case "2": {
            ...
            const res = require('./cache/dhbc2.json')
            const length1 = res.doanhinh.length
            const dataGame = res.doanhinh[Math.floor(Math.random() * length1)]
        ...
        case "1": {
            api.unsendMessage(handleReply.messageID);
            const res = require('./cache/dhbc1.json')
